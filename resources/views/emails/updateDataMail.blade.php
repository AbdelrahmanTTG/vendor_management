    ...
    @if (isset($mailData['personalData']))
        ...
        <table border="0" cellpadding="2" cellspacing="0">
            <tbody>
                ...
                <tr>
                    <td width="1200">
                        <p><strong>Contact Name:</strong>{{ $mailData['personalData']->prfx_name }}
                            {{ $mailData['personalData']->contact_name }} </p>
                    </td>
                </tr>
                <tr>
                    <td width="1200">
                ...
                <tr>
                    <td width="1200">
                        <p><strong>Phone Number :</strong> {{ $mailData['personalData']->phone_number }} <strong>Another
                                Number :</strong> {{ $mailData['personalData']->Anothernumber }} </p>
                    </td>
                </tr>
                <tr>
                    <td width="1200">
                        <p><strong>Country of residence :</strong> {{ $mailData['personalData']->countryName->name }}
                        </p>
                    </td>
                <tr>
                <tr>
    ...
    @if (isset($mailData['billingData']))
        ...
        <table border="0" cellpadding="2" cellspacing="0">
            <tbody>
                ...
                <tr>
                    <td width="1200">
                        <p><strong>Billing Legal Name:</strong>
                            {{ $mailData['billingData']['billingData']->billing_legal_name }} </p>
                    </td>
                </tr>
                <tr>
                    <td width="1200">
                ...
                <tr>
                    <td width="1200">
                        <p><strong>Billing Currency :</strong>
                            {{ $mailData['billingData']['billingData']->billing_currency->name }} </p>
                    </td>
                </tr>
                @if (isset($mailData['billingData']['bankData']) && is_object($mailData['billingData']['bankData']))
                    <hr />
                    <tr>
                        <td width="1200">
                            <hr />
                    ...
                    <tr>
                        <td width="1200">
                            <p><strong>Account holder :</strong>
                                {{ $mailData['billingData']['bankData']->account_holder }} </p>
                        </td>
                    </tr>
                    <tr>
                        <td width="1200">
                    ...
                    <tr>
                        <td width="1200">
                            <p><strong>Bank Address :</strong> {{ $mailData['billingData']['bankData']->bank_address }}
                            </p>
                        </td>
                    </tr>
                @endif

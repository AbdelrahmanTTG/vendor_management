...
import { Card, CardBody, CardHeader, Col, Collapse, Label, Row, Input, Table, Media } from 'reactstrap';
                    ...
                    <CardBody>
                        ...
                        {isChecked && 
                         ...
                         <div className="border border-default p-3 mb-3 test_details" style={{ borderStyle: "dashed!important" }}>
                             <Label className="col-form-label m-r-10">Test specification</Label>
                             <Row>
                                 <Col md="4" className="mb-3">
                                     <Label className="form-label" for="validationCustom01">Source</Label>
                                     <Select defaultValue={{ isDisabled: true, label: '-- Select Source Language --' }} className="js-example-basic-single col-sm-12" />
                                 </Col>

                                 <Col md="4" className="mb-3">
                                     <Label className="form-label" for="validationCustom01">Target</Label>
                                     <Select defaultValue={{ isDisabled: true, label: '-- Select Source Language --' }} className="js-example-basic-single col-sm-12" />
                                 </Col>
                                 <Col md="4" className="mb-3">
                                     <Label className="form-label" for="validationCustom01">Main-Subject Matter</Label>
                                 ...
                                 <Col md="4" className="mb-3">
                                     <Label className="form-label" for="validationCustom01">Sub–Subject Matter</Label>

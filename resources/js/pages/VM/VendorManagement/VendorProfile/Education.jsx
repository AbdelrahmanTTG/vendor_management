...
import { Card, CardBody, CardHeader, Col, Collapse, Label, Row,Input } from 'reactstrap';
                    ...
                    <CardBody>
                        <Row className="g-3 mb-3">
                            <Col md="6" className="mb-3">
                                <Label className="form-label" for="validationCustom01">University name</Label>
                                <Input className="form-control" type="text" placeholder="University name" />
                            </Col>

                            <Col md="6" className="mb-3">
                                <Label className="form-label" for="validationCustom01">Latest Degree</Label>
                            ...
                            <Col md="6" className="mb-3">
                                <Label className="form-label" for="validationCustom01">Year of graduation</Label>
